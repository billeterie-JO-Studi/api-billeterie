...
export interface ApiCheckoutCheckout extends Schema.CollectionType {
  ...
  attributes: {
    ...
    offre: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCommandCommand extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date_purchasse: Attribute.DateTime;
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    begin_event: Attribute.DateTime;
    end_event: Attribute.DateTime;
    place_event: Attribute.String;
    nb_places_max: Attribute.Integer;
    tickets: Attribute.Relation<
      'api::event.event',
      'oneToMany',
      'api::ticket.ticket'
